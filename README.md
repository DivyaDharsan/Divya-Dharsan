<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Divya%20Dharsan&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Support%20Engineer%20%7C%20Full%20Stack%20Dev%20%7C%20Tech%20Enthusiast&descAlignY=62&descSize=16" width="100%"/>

<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=70A5FD&center=true&vCenter=true&width=750&lines=Hey+there%2C+I%27m+Divya+Dharsan+%F0%9F%91%8B;Support+Engineer+%7C+Troubleshooter+%7C+Builder;Full+Stack+%2B+Digital+Marketing+%7C+Chennai;Turning+Problems+Into+Solutions+%F0%9F%94%A7" alt="Typing SVG" />
  </a>
</div>
...
![Cloud Essentials](https://img.shields.io/badge/Cloud%20Essentials-4285F4?style=flat-square&logo=googlecloud&logoColor=white)
...
**Networking & Support Concepts**

![DNS](https://img.shields.io/badge/DNS-38BDAE?style=flat-square&logo=cloudflare&logoColor=white)
![HTTP/HTTPS](https://img.shields.io/badge/HTTP%2FHTTPS-BF91F3?style=flat-square&logo=internetexplorer&logoColor=white)
![Ticket Handling](https://img.shields.io/badge/Ticket%20Handling-70A5FD?style=flat-square&logo=jira&logoColor=white)
...
<details>
  <summary><b>🏢 Half Space Digital Marketing Agency — Full Stack Digital Marketing Executive | 2025–2026 | Chennai</b></summary>
  <br/>

  > **Tech & Skills Used:**
  > `WordPress` `Shopify` `HTML/CSS` `SEO` `Client Support` `Troubleshooting` `Web Maintenance`

  - 📋 Managed **multiple client projects** end-to-end, handling technical coordination for websites and digital platforms
  - 🛠️ Diagnosed and resolved website-related issues, ensuring **smooth, uninterrupted client operations**
  - 🤝 Directly interfaced with clients to capture requirements, debug technical concerns, and deliver solutions
  - 📈 Strengthened communication and problem-solving skills through hands-on **client support and escalation handling**
...
|:-------:|:-----:|:----------:|
| 🛒 **E-Commerce & Business Websites** | WordPress · Shopify · HTML · CSS · SEO | Managed development, maintenance & troubleshooting of multiple live client websites; improved performance and content quality across projects |
...
| 🏅 | Achievement | Details |
|:--:|:-----------:|:-------:|
| 🐍 | **Full Stack With Python** | Certified by Guvi & QSpiders |
| 🐍 | **Python Programming** | Certified by EduPrep |
| 🎨 | **Adobe Photoshop** | Certified by Great Learning |
| 🌐 | **HTML & CSS** | Certified by Meta |
| ☁️ | **Cloud Essentials** | Certified by Nanmudhalvan |
| 🎨 | **UI/UX Design** | Certified by Duzine IT Solutions |
...
|:------:|:-----------:|:----:|:-----:|
| 🎓 BE in Computer Science | University College of Engineering, Dindigul | 2020 – 2024 | — |
| 📚 SSLC & HSLC | M.S.R. Matric. Hr. Sec. School, Madurai | 2020 | — |
...
```
☁️  Cloud Computing     →  AWS Basics, Cloud Essentials, GCP Fundamentals
🐧  Linux               →  Command Line, File System, Bash Scripting
🌐  Networking          →  TCP/IP, DNS, DHCP, HTTP/HTTPS, Subnetting
🛠️  System Admin        →  Windows Server, Remote Tools, Ticket Systems
🗄️  SQL & Databases     →  Queries, Joins, Indexing, DB Administration
🔒  Cybersecurity Basics→  Fundamentals of IT Security & Incident Response
```
